    ...
    while True:
        try:
            ...
            for event in events_stream:
                ...
                # Skip events for monitorbot, caddy, and non-compose containers to avoid feedback loops
                if "monitorbot" in container_name or container_name == "caddy" or "com.docker.compose.project" not in attributes:
                    continue
